  ...
  return (
    <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]" id="services">
        <div className="text-center">
            <span className="bg-neutral-900 text-blue-500 rounded-full h-6 text-md font-medium px-2 py-1 uppercase">
                Serviços
            </span>
            <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide">
                Transformando espaços,
                <span className="bg-gradient-to-r from-blue-400 to-blue-800 text-transparent bg-clip-text">{" "}construindo o futuro.</span>
            </h2>
        </div>
